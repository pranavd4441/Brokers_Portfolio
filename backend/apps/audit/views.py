    ...
    def get(self, request, *args, **kwargs):
        ...
        if "postgresql" in db_engine:
            try:
                ...
                pass  # nosec B110
        metrics.append(
            "# HELP django_db_connections_active Active database connections."
        )
        ...
        try:
            ...
            metrics.append(
                "# HELP process_max_rss_kb Maximum resident set size in kilobytes."
            )
