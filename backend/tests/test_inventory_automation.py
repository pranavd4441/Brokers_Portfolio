...
def test_setup():
    # Create tenants
    tenant_a = Tenant.objects.create(name="Tenant A", listing_expiry_days=15, brand_color="#10B981")
    tenant_b = Tenant.objects.create(name="Tenant B", listing_expiry_days=45, brand_color="#3B82F6")
