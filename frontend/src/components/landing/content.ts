...
export const COPY = {
  en: {
    ...
    heroMockup: {
      ...
      tag: 'Residential · For Sale',
      title: 'Garden Residence in Baner',
      price: '₹1.65 Cr',
      specs: ['3 BHK', '1,460 sq ft', 'Ready to move'],
      chatBtn: 'Inquire on WhatsApp',
      bubbleSender: 'You (via WhatsApp)',
      bubbleMessage: 'Check this 3 BHK in Baner: propertyos.in/p/baner-garden 🏡',
      bubbleClient: 'Buyer: "Looks great! When can we visit for a walkthrough?"',
    },
    walkthroughVisuals: [
      {
        badge: 'Step 01 · Input',
        heading: 'Property Form',
        meta: '6 Photos · ₹1.65 Cr · Baner, Pune',
        tag: 'Auto-formatted',
      },
      {
        badge: 'Step 02 · Share',
        heading: 'Live Branded Page',
        meta: 'propertyos.in/p/prime-baner',
        tag: '1-Click WhatsApp',
      },
      {
        badge: 'Step 03 · Grow',
        heading: 'Direct Buyer Lead',
        meta: 'Rohan M. • Site visit request',
        tag: 'Instant Alert',
      },
    ],
    pricingBadges: {
  ...
  hi: {
    ...
    heroMockup: {
      agency: 'प्राइम रियल्टी',
      city: 'पुणे',
      verified: 'वेरिफाइड ब्रोकर',
      tag: 'आवासीय · बिक्री के लिए',
      title: 'बाणेर में गार्डन वाला घर',
      price: '₹1.65 करोड़',
      specs: ['3 BHK', '1,460 वर्ग फुट', 'रहने के लिए तैयार'],
      chatBtn: 'WhatsApp पर पूछताछ करें',
      bubbleSender: 'आप (WhatsApp द्वारा)',
      bubbleMessage: 'बाणेर में यह 3 BHK देखें: propertyos.in/p/baner-garden 🏡',
      bubbleClient: 'ग्राहक: "बहुत बढ़िया! विज़िट कब कर सकते हैं?"',
    },
    walkthroughVisuals: [
      {
        badge: 'स्टेप 01 · इनपुट',
        heading: 'प्रॉपर्टी फॉर्म',
        meta: '6 तस्वीरें · ₹1.65 करोड़ · बाणेर, पुणे',
        tag: 'ऑटो-फॉर्मेट',
      },
      {
        badge: 'स्टेप 02 · शेयर',
        heading: 'ब्रांडेड लाइव पेज',
        meta: 'propertyos.in/p/prime-baner',
        tag: '1-क्लिक WhatsApp',
      },
      {
        badge: 'स्टेप 03 · लीड्स',
        heading: 'सीधी ग्राहक पूछताछ',
        meta: 'रोहन एम. • विज़िट की दरख्वास्त',
        tag: 'त्वरित अलर्ट',
      },
    ],
    pricingBadges: {
      proBadge: 'फाउंडिंग ऑफर — पहले 100 ब्रोकर्स',
      zeroCut: 'लीड्स और सौदों पर 0% कमीशन',
    },
  ...
  mr: {
    ...
    heroMockup: {
      agency: 'प्राइम रिअल्टी',
      city: 'पुणे',
      verified: 'व्हेरीफाईड ब्रोकर',
      tag: 'निवासी · विक्रीसाठी',
      title: 'बाणेरमधील बाग असलेले घर',
      price: '₹1.65 कोटी',
      specs: ['3 BHK', '1,460 चौ. फूट', 'तयार'],
      chatBtn: 'WhatsApp वर चौकशी करा',
      bubbleSender: 'तुम्ही (WhatsApp द्वारे)',
      bubbleMessage: 'बाणेरमधील हे 3 BHK पहा: propertyos.in/p/baner-garden 🏡',
      bubbleClient: 'ग्राहक: "छान आहे! प्रत्यक्ष कधी पाहता येईल?"',
    },
    walkthroughVisuals: [
      {
        badge: 'पायरी 01 · माहिती',
        heading: 'प्रॉपर्टी फॉर्म',
        meta: '6 फोटो · ₹1.65 कोटी · बाणेर, पुणे',
        tag: 'ऑटो-फॉर्मेट',
      },
      {
        badge: 'पायरी 02 · शेअर',
        heading: 'ब्रँडेड लाइव्ह पेज',
        meta: 'propertyos.in/p/prime-baner',
        tag: '1-क्लिक WhatsApp',
      },
      {
        badge: 'पायरी 03 · चौकशी',
        heading: 'थेट ग्राहक चौकशी',
        meta: 'रोहन एम. • प्रत्यक्ष भेटीची विनंती',
        tag: 'झटपट अलर्ट',
      },
    ],
    pricingBadges: {
      proBadge: 'फाउंडिंग ऑफर — पहिले 100 ब्रोकर्स',
      zeroCut: 'लीड्स आणि व्यवहारांवर 0% कमिशन',
    },
