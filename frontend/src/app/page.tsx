...
const languageCopy = {
  en: {
    headline: <>Your properties. Your brand. <em className="not-italic text-[#a94232]">One professional link.</em></>,
  ...
  hi: {
    headline: <>आपकी प्रॉपर्टी। आपका ब्रांड। <em className="not-italic text-[#a94232]">एक प्रोफेशनल लिंक।</em></>,
  ...
  mr: {
    headline: <>तुमच्या प्रॉपर्टी. तुमचा ब्रँड. <em className="not-italic text-[#a94232]">एक प्रोफेशनल लिंक.</em></>,
        ...
        <div className="relative grid min-h-[570px] place-items-center overflow-hidden bg-[#10221c] px-3 py-10 sm:px-8">
          ...
          <div className="relative h-[500px] w-full max-w-[500px]">
            ...
            <div className="absolute left-[3%] top-3 w-[220px] -rotate-3 rounded-[31px] bg-[#050907] p-2 shadow-2xl sm:left-[6%] sm:w-[245px]">
              <div className="overflow-hidden rounded-[24px] bg-[#f6f4ec] text-[#10221c]"><div className="flex justify-between px-4 py-3 text-[8px] font-bold"><span>9:41</span><span>● ● ●</span></div><div className="flex h-[188px] items-end bg-[linear-gradient(160deg,rgba(8,22,17,.05),rgba(8,22,17,.65)),linear-gradient(135deg,#d0b39d,#617b6e)] p-4"><span className="rounded-full bg-[#10221c]/80 px-2 py-1 text-[8px] text-white">Details provided by broker</span></div><div className="p-4"><p className="text-[8px] font-bold tracking-[.12em] text-[#5f6c66]">PRIME REALTY · PUNE</p><p className="mt-2 text-xl font-black leading-tight tracking-[-.04em]">Sunlit 3 BHK in Baner</p><div className="mt-2 flex items-center justify-between text-[10px]"><strong className="text-base">₹1.65 Cr</strong><span>For sale</span></div><div className="my-3 grid grid-cols-3 gap-1 text-center text-[8px]"><span className="rounded-lg bg-[#e8eadf] py-2">3 BHK</span><span className="rounded-lg bg-[#e8eadf] py-2">1,460 ft²</span><span className="rounded-lg bg-[#e8eadf] py-2">Ready</span></div><div className="rounded-xl bg-[#10221c] py-3 text-center text-[10px] font-black text-[#b7f34b]">Chat with Aakash on WhatsApp</div></div></div>
            </div>
